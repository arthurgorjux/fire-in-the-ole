...
/**
 * Cette classe permet d'extraire d'un fichier bitmap un tableau d'entrée 
 * @author S219
 */
public class BitmapLoader {
     ...
     * @return La valeur de la composante de vert d'un pixel, comprise entre 0
     * et 255
     */
     ...
     * @return La matrice de difficulté d'une image, sous la forme d'un tableau
